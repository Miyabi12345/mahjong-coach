 ...
 *
 * これは**ブラウザ版**（MediaRecorder）。アプリ版は useRecorder.native.ts（expo-audio）。
 * どちらを使うかは Metro が拡張子（.web / .native）で選ぶ。
...
/** 録音の受け渡し（ブラウザは blob、アプリは base64。src/api/game.ts の transcribeInGame が受け取る） */
